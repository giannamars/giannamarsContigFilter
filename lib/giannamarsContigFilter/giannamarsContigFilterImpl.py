...
This sample module contains one small method that filters contigs.
    ...
    def run_giannamarsContigFilter(self, ctx, params):
        """
        ...
        #BEGIN run_giannamarsContigFilter

        # Print statements to stdout/stderr are captured and available as the App log
        logging.info('Starting run_giannamarsContigFilter function. Params=' + pformat(params))
        ...
        #END run_giannamarsContigFilter

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_giannamarsContigFilter return value ' +
                             'output is not type dict as required.')
        # return the results
        return [output]

    def run_giannamarsContigFilter_max(self, ctx, params):
        """
        This example function accepts any number of parameters and returns results in a KBaseReport
        :param params: instance of mapping from String to unspecified object
        :returns: instance of type "ReportResults" -> structure: parameter
        ...
        # ctx is the context object
        # return variables are: output
        #BEGIN run_giannamarsContigFilter_max
        output = {}
       ...
       # Return the report reference and name in our results
        ...
        #END run_giannamarsContigFilter_max

        # At some point might do deeper type checking...
        if not isinstance(output, dict):
            raise ValueError('Method run_giannamarsContigFilter_max return value ' +
                             'output is not type dict as required.')
        # return the results
        return [output]
    def status(self, ctx):
